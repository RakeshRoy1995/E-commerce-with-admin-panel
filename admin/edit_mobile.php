...
<body>
  <section id="container">
	...
	require('../dbcon.php');
	$id=$_REQUEST['id'];
	$result = $mysqli->query("SELECT * FROM mobile where id=$id");
	if($result === FALSE){
        die(mysqli_error());
      }
	else{
...
<p><input type="file" name="image"  required value="<?php echo $obj->image ?>" /></p>
...
$update="update mobile set name='".$name."', code='".$code."',image='".$target."', price='".$price."',qty='".$qty."' where id='".$id."'";
