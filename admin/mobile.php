  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
		...
		<p><a href="index.php">Home</a> | <a href="mobile_insert.php">Insert New Record</a> </p>
		...
		if (!empty($_REQUEST['id'])) {
		    ...
		    $result =$mysqli->query( "DELETE FROM mobile WHERE id=$id");
    ...
    <footer class="site-footer">
      <div class="text-center">
        <p>
          &copy; Copyrights <strong>Rakesh</strong>. All Rights Reserved
        </p>
        <div class="credits">
